...
def viewdir_fn(
    viewdir_mlp_model, viewdir_mlp_params, rgb_features, viewdirs, scene_params
):
    ...
    viewdirs_enc = model_utils.posenc(
        viewdirs, 0, scene_params["_deg_view"], scene_params["_legacy_posenc_order"]
    )
    ...
    raw_rgb, _ = viewdir_mlp_model.apply(viewdir_mlp_params, viewdirs_enc_features)
