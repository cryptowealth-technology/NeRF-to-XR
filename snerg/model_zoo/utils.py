...
def define_flags():
    ...
    flags.DEFINE_integer(
        "num_viewdir_channels", 4, "number of extra channels used for view-dependence."
    )
    flags.DEFINE_integer("viewdir_net_depth", 2, "depth of the view-dependence MLP.")
    flags.DEFINE_integer("viewdir_net_width", 16, "width of the view-dependence MLP.")
    ...
    flags.DEFINE_float(
        "sparsity_strength", 0.0, "weight for the sparsity loss" "(Cauchy on density)."
    )
    flags.DEFINE_bool(
...
def render_image(render_fn, rays, rng, normalize_disp, chunk=8192):
    ...
    return (
        ...
        specular.reshape((height, width, -1)),
    )
